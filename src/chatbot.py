...
class GanaderiaChatbot:
    def __init__(self, db_connection):
        ...
        self.respuestas = {
            "saludo": [
                "¡Hola! Soy tu asistente ganadero. ¿En qué puedo ayudarte?",
                "Buen día, estoy aquí para ayudarte con tu sistema ganadero."
            ],
            "ayuda": [
                "Puedo ayudarte con consultas sobre tus animales, registro de datos y consejos de manejo.",
                "Estoy preparado para asistirte en gestión ganadera. ¿Qué necesitas?"
            ],
            "animales": [
                "Puedo proporcionarte información sobre tus animales registrados.",
                "Tengo acceso a los datos de tu rebaño. ¿Qué quieres saber?"
            ],
            "default": [
                "Disculpa, no entendí completamente tu pregunta. ¿Podrías ser más específico?",
                "No estoy seguro de cómo responder. ¿Puedes reformular tu consulta?"
            ]
        }
